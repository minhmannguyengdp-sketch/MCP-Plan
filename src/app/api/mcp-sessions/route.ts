...
function toRouteOptions(routeRows: RouteRow[], sessions: SessionTableRow[]): RouteOption[] {
...
function toSession(row: SessionTableRow, routes: RouteOption[], agg: Record<string, SessionAgg>): SessionRow {
...
export async function GET(request: Request) {
  try {
    ...
    const routeId = text(url.searchParams.get("routeId"));
