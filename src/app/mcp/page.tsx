...
const MCP_MODULES = [
  ...
  { href: "/routes", tone: "session", icon: "◇", title: "Phiên MCP hôm nay", description: "Mở hoặc tiếp tục phiên làm việc từ tuyến gốc đã chọn; đây không phải tuyến mới.", cta: "Mở phiên" },
  { href: "/mcp/sessions", tone: "session", icon: "▤", title: "Phiên", description: "Xem lại lịch sử chạy tuyến theo ngày, tuần hoặc tháng.", cta: "Xem lịch sử" },
