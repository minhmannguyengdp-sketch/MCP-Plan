...
export const PRIMARY_NAV_ITEMS: NavItem[] = [
  ...
  { label: "BC phiên", shortLabel: "BC", href: "/reports", description: "BC được lưu khi chốt phiên MCP", icon: "▣" },
...
export const SIDEBAR_NAV_ITEMS: NavItem[] = [
  ...
  { label: "Phiên", shortLabel: "Phiên", href: "/mcp/sessions", description: "Lịch sử phiên chạy tuyến theo ngày, gồm các nhánh trong phiên", icon: "▤" },
