-- Gate 7C: keep selected catalog variant when saving MCP orders.
...
grant execute on function public.mcp_create_order_from_session_customer(text, jsonb, text, text) to anon, authenticated, service_role;
